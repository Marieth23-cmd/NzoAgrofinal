...
<h1 className="text-center my-6  mx-0 text-[2rem] font-bold text-marieth" >Frutas</h1>
...
<div className=" gap-4  grid grid-cols-3  ">
      ...
      <label htmlFor="Frutas"  className="mb-[0.5rem] font-medium block" >Tipo de Fruta
     ...
     <label htmlFor="intrvalo-preco" className="mb-[0.5rem] font-medium block "   >   Faixa de Preço (AOA)
      ...
      <section>
         ...
         <div className="  p-8 max-w-[1200px]  grid  grid-cols-3 gap-6  -mt-16 ml-6" > 
