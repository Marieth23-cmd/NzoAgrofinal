...
import Footer from "../Components/Footer";
 ...
 export default function SelectPage(){ 
     ...
     return(
       ...
       <div className=" ml-8 hover:translate-y-2 bg-white rounded-[15px] p-8 text-center mb-15 max-w-[300px] cursor-pointer shadow-custom lg:mb-20" > 
       ...
       <div className=" w-20 h-10 m-0 mx-auto mb-6 ">
        ...
        <div className="ml-8 hover:translate-y-2  bg-white rounded-[15px] p-8 text-center mb-15 max-w-[300px] cursor-pointer shadow-custom transition-transform lg:mb-20" >
