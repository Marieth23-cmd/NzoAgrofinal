...
<h1 className="text-center my-6  mx-0 text-[2rem] font-bold text-marieth" >Insumos Agrícolas</h1>
...
<div className=" gap-4  grid grid-cols-3 ">
      ...
      <label htmlFor="Frutas"  className="mb-[0.5rem] font-medium block" >Tipo de Insumo
      <div className="p-4  shadow-custom  bg-white rounded-[10px] "  >
        ...
        <option value="Sementes(Milho, Feijão, Trigo)">Sementes(Milho, Feijão, Trigo)</option>
        <option value="Fertilizantes(Organicos e Químicos)">Fertilizantes(Organicos e Químicos)</option>
        <option value="Frramentas Agrícolas(Enxadas , foices)">Frramentas Agrícolas(Enxadasm foices)</option>
        <option value="Pesticidas e Herbicidas">Pesticidas e Herbicidas</option>
        <option value="Irrigação(Aspersores , mangueiras)">Irrigação(Aspersores , mangueiras)</option>
