        ...
        <main>
            <Head>
                <title>Começar a Comprar</title>
                 ...
                 <Navbar/>
            <div className="p-8 mb-8 mx-auto  mt-[24%] text-center  max-w-[800px] lg:mt-[20%]">
             ...
             " href="./TodosProdutos">Ver Todos os Produtos</a>
                    ...
                    <div className="  gap-8 mt-12 py-0 px-8 ">
                        ...
                        <div className=" flex items-center justify-center  rounded-[10px] text-center p-6 cursor-pointer bg-branco  shadow-custom transition-colors duration-150 ease-in-out hover:translate-y-2" >
                            <h1 className="mt-[0.5rem] font-bold text-[18.72px] text-profile" >
                    ...
                    <div className="  gap-8  p-8" >
                        <div className=" flex items-center justify-center  rounded-[10px] text-center p-6 cursor-pointer shadow-custom transition-colors duration-150 ease-in-out hover:translate-y-2 bg-branco ">
