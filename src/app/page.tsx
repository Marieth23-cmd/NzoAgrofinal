...
export default function Home() {
  ...
  // useEffect para troca de imagens de fundo
  useEffect(() => {
    let index = 0;
      ...
      <div>
        ...
        >
          <div className="w-full max-w-3xl px-4 flex flex-col items-center">
            ...
            <p className="-ml-[82.8px] lg:-ml-[130px] text-center w-full hidden lg:block">
              Encontre produtos frescos direto dos produtores locais
            </p>
            <button 
              onClick={redirecionamento} 
              className="-ml-[82.8px] lg:-ml-[130px] mt-1 bg-marieth text-white py-2 px-4 lg:mt-2 lg:py-4 lg:px-8 text-[1.1rem] border-none rounded-[5px] cursor-pointers hover:bg-verdeaceso transition-colors duration-150"
            >
              Começar a Comprar
            </button>
          </div>
