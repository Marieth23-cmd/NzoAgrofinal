...
export default function categoriaTuberculos() {
  ...
  return (
    <main>
      <Head>
        <title>Categoria Tuberculos</title>
      </Head>
      <Navbar />

      <div className="mb-20 mt-[52%] lg:mt-[18%]">
        <h1 className="text-center my-6 text-[1.5rem] lg:text-[2rem] sm:text-[1.75rem] md:text-[2rem] font-bold text-marieth"> Raízs e Tubérculos</h1>
        ...
        <div className="my-12 mx-4 sm:mx-6 md:mx-9 px-2 sm:px-3 md:px-4">
          <div className="flex flex-col gap-4 lg:flex-row justify-between w-full">
            ...
            <div className="flex flex-col w-full">
              <label htmlFor="tubeculos" className="mb-[0.5rem] font-medium block">
                Tipo de Tubérculo
                {/* Select para tipos de tubérculos */}
